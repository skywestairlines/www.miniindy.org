...
$val .= \SilverStripe\View\SSViewer::execute_template([["type" => "Includes", 'SilverStripe\\Admin\\LeftAndMain_ViewModeSelector'], 'SilverStripe\\Admin\\LeftAndMain_ViewModeSelector'], $scope->getItem(), array('SelectID' => 'preview-mode-dropdown-in-content'), $scope, true);
