...
class Forum extends Page {
	...
	public function requireDefaultRecords() {
		...
		if(!DataObject::get_one("ForumHolder")) {
			...
			$forumholder->Content = "<p>"._t('Forum.WELCOMEFORUMHOLDER','Welcome to the Mini Indy Forum! You can now add forums.')."</p>";
			...
			$forum->Content = "<p>"._t('Forum.WELCOMEFORUM','Welcome to the Mini Indy Forum! You can now add topics.')."</p>";
