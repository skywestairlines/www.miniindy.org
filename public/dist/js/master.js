...
(function ($) {
    ...
    var AlertsForm = '#Form_AlertSignUp',
        ...
        checkEmailInput = function checkEmailInput(email) {
        var regex = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
        return regex.test(email);
    },
        validateEmail = function validateEmail(selector, form) {
        $(form + ' .message').html('');
        ...
        sendMessageBox = function sendMessageBox(form) {
        $(form + ' .type').text('');
        ...
        alertMessageBox = function alertMessageBox(alert, form, title) {
        ...
        $(form + ' .alert').removeClass('alert-success alert-warning alert-danger alert-info alert-primary');
        $(form + ' .alert').addClass('alert-' + alert.type);
        if (title && (typeof title === "undefined" ? "undefined" : _typeof(title)) !== undefined) {
            $(form + ' .type').text(alert.title + '<br>');
        }
        $(form + ' .message').html(alert.message);
        $(form + ' .alert').fadeIn();
...
(function () {
    var n = this,
     ...
     true ? ("undefined" != typeof module && module.exports && (exports = module.exports = w), exports._ = w) : n._ = w, w.VERSION = "1.4.4";
    ...
    var I = function I(n, t, r, e) {
        ...
        if ("object" != (typeof n === "undefined" ? "undefined" : _typeof(n)) || "object" != (typeof t === "undefined" ? "undefined" : _typeof(t))) return !1;
...
(function (c) {
    var n = -1,
        ...
        if ("object" === (typeof a === "undefined" ? "undefined" : _typeof(a))) return c.extend(b, a);
...
(function ($) {
    ...
    var setTime = function setTime(time) {
        ...
        displayStockQuote = function displayStockQuote(stockQuote) {
        ...
        getUserQuote = function getUserQuote(ticker) {
        ...
        getQuote = function getQuote(ticker) {
        $.ajax({
        ...
        getData = function getData(ticker) {
        $.ajax({
            url: YHOOApi,
            cache: false,
            type: 'GET',
            ...
            if ((typeof stockQuote === "undefined" ? "undefined" : _typeof(stockQuote)) === ( true ? "undefined" : _typeof(undefined)) || stockQuote === false) {
                return;
            }
...
(function ($) {
    ...
    Markit.InteractiveChartApi.prototype.PlotChart = function () {
        ...
        $.ajax({
            ...
            error: function error(response, txtStatus) {}
        });
    };
...
(function ($) {
    ...
    (function ($) {
        ...
        if ((typeof classes === "undefined" ? "undefined" : _typeof(classes)) !== ( true ? "undefined" : _typeof(undefined))) thisClass = classes.split(' ');
        var swapRouteMapText = function swapRouteMapText() {
